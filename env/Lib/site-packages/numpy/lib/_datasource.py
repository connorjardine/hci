...
Example::
    ...
    >>> #     './www.google.com/map.html'
    >>> # opens the file and returns a file object.
    >>> fp = ds.open('http://www.google.com/map.html')
    >>>
...
class DataSource (object):
    ...
    will fail::
        ...
        >>> repos = DataSource()
        >>> repos.exists('www.google.com/map.html')
        False
        >>> repos.exists('http://www.google.com/map.html')
        True
    ...
    ::
        ...
        >>> urlname = 'http://www.google.com/map.html'
        >>> gfile = ds.open('http://www.google.com/map.html')  # remote file
        >>> ds.abspath(urlname)
        '/home/guido/www.google.com/site/map.html'
