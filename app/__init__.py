...
def show_map():
    ...
    img_str = ".\static\map_" + str(curryr) + currg.lower() + "Ratio.png"
...
def show_graph():
    ...
    left = figure(title="Patients / 10000 Population with Alcohol Related Health Conditions in:",
               x_axis_label='Year',
               y_axis_label='Patients', y_range=(0, largest + 10))
    ...
    right = figure(title="Patients / 10000 Population with Mental Health Conditions in:",
                  x_axis_label='Year',
                  y_axis_label='Patients', y_range=(0, largest + 10))
